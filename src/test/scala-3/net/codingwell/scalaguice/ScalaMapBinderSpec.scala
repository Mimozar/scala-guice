...
class ScalaMapBinderSpec extends AnyWordSpec with Matchers {
  ...
  private inline def validate[K, V](module: Module, expected: (K, V)*): Unit = {
  ...
  private inline def validateMultiMapWithAnnotation[K: ClassTag, V: ClassTag](module: Module, annotation: Annotation, expected: (K, im.Set[V])*): Unit = {
    val injector = Guice.createInjector(module)
  ...
  private inline def validateMultiMapWithAnn[K: ClassTag, V: ClassTag, Ann <: Annotation : ClassTag](module: Module, expected: (K, im.Set[V])*): Unit = {
    val injector = Guice.createInjector(module)
